...
11. Run the full ship verifier from the repo root:
   ...
   state accepts a non-JSON write, an invalid selected work id, a malformed or
   overlong work text field, malformed work string list, or oversized receipt shape, if hosted
