...
const expectedContractRoutes = ["home", "review", "work", "next", "memory", "create", "pack", "compare", "calendar", "settings", "insights", "activity", "terms"];
...
function copyLayerPanelContractOk() {
  return includesAll(source, [
