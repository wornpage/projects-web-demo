...
const VALID_COPY_PROFILES = new Set(["climate", "developer", "dj", "general", "ai", "sales", "ops"]);
const VALID_SCENARIOS = new Set(["default", "due-view", "empty", "healthy", "onboarding", "review", "ai-prompts", "ai-evals", "ops-day", "sales"]);
